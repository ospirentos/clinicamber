...
export function ServiceCard({title, shortText, image}) {
    return (
        <Card className="min-w-[12rem] my-4 sm:col-span-12 sm:col-span-4 sm:h-[300px]" isFooterBlurred>
            ...
            <CardFooter className="justify-center sm:justify-between bg-black/40 before:bg-white/10 border-white/20 overflow-hidden absolute bottom-0 w-full z-10">
                <p className="hidden sm:block sm:text-tiny sm:text-white/80">{shortText}</p>
